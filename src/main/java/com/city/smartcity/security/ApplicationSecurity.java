...
public class ApplicationSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/etudiant").hasAnyRole("ETUDIANT")
                .antMatchers("/tourisme").hasAnyRole("TOURISTE")
                .antMatchers("/affaire").hasAnyRole("AFFAIRE")
                .antMatchers("/emploi").hasAnyRole("EMPLOI")
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
