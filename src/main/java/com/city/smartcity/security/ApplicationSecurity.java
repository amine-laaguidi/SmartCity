...
public class ApplicationSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/etudiant","/etudiant/**").hasAnyRole("ETUDIANT","ADMIN")
                .antMatchers("/tourisme","/tourisme/**").hasAnyRole("TOURISTE","ADMIN")
                .antMatchers("/api/tourisme").hasAnyRole("TOURISTE","ADMIN")
                .antMatchers("/affaire","/affaire/**").hasAnyRole("AFFAIRE","ADMIN")
                .antMatchers("/emploi","/emploi/**").hasAnyRole("EMPLOI","ADMIN")
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
